...
const MergeLocalizationPlugin = require('merge-localizations');
...
const localizationLoader = {
  loader: path.resolve('./node_modules/localizations-loader'),
  options: { 
    sourceRoot: 'src', // THIS root must be same as root of translations
    locFolderName: METADATA.translationsFolder
  }
}
...
module.exports = {
  ...
  "module": {
    "rules": [
      ...
      {
        "test": /\.ts$/,
        "use": [localizationLoader, "@ngtools/webpack"]
      }
    ]
  },
  "plugins": [
    ...
    new MergeLocalizationPlugin({
      ...
      rootDir: 'src',
      omit: new RegExp(`app-translations|${METADATA.translationsFolder}|`, 'g'),
